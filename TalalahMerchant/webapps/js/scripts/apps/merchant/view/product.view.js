...
define(function(require,exports,module){
	...
	var ProductView = Backbone.View.extend({
		...
		render : function(){
			...
			this.$el.find('img').attr('src','/TalalahMerchant/content/'+mcc+"/"+mcId+"/"+id+"/default.png");
			return this.$el;
		},
		events : {
	...
	var ProductImgView = Backbone.View.extend({
		render		:	function(){
			...
			if($.isEmptyObject(data.merchant.merchantCode)===false){
				...
				var pId		= data.id;
				var img		= "default.png";
				this.$el.find('#productImg').attr('src','/TalalahMerchant/content/'+mcc+'/'+mcId+'/'+pId+'/'+img);
			}
			else{
		...
		render		:	function(){
			...
			if($.isEmptyObject(this.model)===false){
				...
				if(data.tag !== null){
					...
					this.$el.find('#img').attr('src','/TalalahMerchant/content/'+mcc+'/'+mcId+'/'+pId+'/'+name);
				}
			}
			else{
